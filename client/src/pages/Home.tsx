  ...
  return (
    <div className="relay-app" id="top">
      ...
      <main>
        ...
        <section className="closing-section"><div className="relay-shell closing-wrap"><motion.div {...reveal}><p className="section-kicker">READY TO START?</p><h2>Bring the right people together and build what matters.</h2></motion.div><motion.div className="closing-actions" {...reveal} transition={{ ...reveal.transition, delay: .07 }}><button type="button" className="primary-button" onClick={() => scrollTo("projects")}>Explore projects <ArrowRight size={18} /></button><button type="button" className="outline-button" onClick={openPosting}>Post a project <Command size={16} /></button></motion.div></div></section>
      </main>
